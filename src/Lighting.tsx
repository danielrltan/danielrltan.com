  ...
  return (
    <>
      ...
      {/* 2. Sun directional: neutral daylight key + shadow caster.
              ...
              Shadow tuning:
              - mapSize stays 1024 (perf budget)
              - bias 0.0001 (positive, moves shadow slightly away
                from caster, conventional default).
              - normalBias 0.05: softens shadow-acne at grazing
                angles without needing aggressive position bias.
              - intensity bumped 1.0 → 1.4 so the cast shadow under
                the room reads with high contrast against the rice-
                grain plane (sun is the only shadow caster).
              - shadow-camera frustum tightened from ±3.2 → ±2.6
                (room footprint is ±2.25); at 1024px that gives
                ~5mm/texel, roughly 25% sharper shadow edges than
                the prior ±3.2 budget. */}
      <directionalLight
        color="#fff8ec"
        intensity={1.4}
