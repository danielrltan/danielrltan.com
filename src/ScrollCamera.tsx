...
const STOPS: ScrollStop[] = [
  { at: 0.0,  position: [50, 50, 50], target: [0, 0.8, 0] },
  { at: 0.13, position: [50, 50, 50], target: [-0.5, 0.8, -0.6] },
  { at: 0.26, position: [50, 50, 50], target: [0, 1.0, 0] },
  { at: 0.40, position: [50, 50, 50], target: [1.2, 1.0, -1.3] },
  { at: 0.55, position: [50, 50, 50], target: [-1.2, 1.2, 1.0] },
  { at: 0.70, position: [50, 50, 50], target: [-1.0, 0.4, 0.5] },
  { at: 0.83, position: [50, 50, 50], target: [0, 1.0, 0] },
  { at: 0.95, position: [50, 50, 50], target: [0, 0.8, 0] },
];
